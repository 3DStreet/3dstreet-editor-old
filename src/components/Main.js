      ...
      <div>
        ...
        >
          ...
          <div id="viewportBar">
			...
			<a href="https://3d.st"><h1 style={{color: "#4B3461", fontSize: "18px", padding: "10px", whiteSpace: "nowrap", fontWeight: "300"}}>3D<span style={{fontWeight: "600"}}>Street</span><span style={{color: "#000000", fontSize: "10px", borderRadius: "3px", background: "#F7CC4E", margin: "6px", padding: "1.5px", paddingRight: "8px", paddingLeft: "8px", verticalAlign: "middle"}}>Editor</span></h1></a>
			<StreetName />
		    <CameraToolbar />
